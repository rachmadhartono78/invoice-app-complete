...
<head>
    <meta charset="UTF-8">
    <title>ECOS | Under Maintenance</title>
...
<body class="bg-gray-100">
                ...
                <div class="w-full flex-col justify-center items-center gap-5 flex">
                    <div class="w-full flex-col justify-center items-center gap-6 flex">
                        <div class="w-full flex-col justify-start items-center gap-2.5 flex">
                            ...
                            <p class="text-center text-gray-500 text-base font-normal leading-relaxed">It's going to take some time to fix. We'll be back online in.</p>
                        </div>
                        ...
                        {{-- <div class="w-full justify-center items-center gap-2.5 flex sm:flex-row flex-col">
                            ...
                            <button class="sm:w-fit w-full px-3.5 py-2 bg-indigo-700 hover:bg-indigo-800 transition-all duration-700 ease-in-out rounded-lg shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] justify-center items-center flex">
    ...
    <script>
        // count-down timer
        let dest = new Date(new Date().getTime() + 24 * 60 * 60 * 1000).setHours(9, 0, 0, 0);
        let x = setInterval(function () {
          ...
          if (diff <= 0) {
            clearInterval(x);
            // Display zeros when countdown is finished
